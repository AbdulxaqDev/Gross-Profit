    ...
    <div class="home-footer">
        ...
        <div class="contacts">
            <RouterLink to="/" class="logoPart">
                <svg class="logo" width="50" height="42" viewBox="0 0 50 42" fill="none"
                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <rect width="49.9796" height="42" fill="url(#pattern0)" />
                    <defs>
                        <pattern id="pattern0" patternContentUnits="objectBoundingBox" width="1" height="1">
                            <use xlink:href="#image0_143_649"
                                transform="translate(0 -0.0120217) scale(0.000882613 0.0010503)" />
                        </pattern>
